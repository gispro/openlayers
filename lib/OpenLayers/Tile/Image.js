    ...
    onImageError: function() {
        ...
        if (img.src != null) {
            ...
            if (this.imageReloadAttempts <= OpenLayers.IMAGE_RELOAD_ATTEMPTS) {
                ...
                this.onImageLoad();
				gxp.plugins.Logger.log("Ошибка при загрузке участка слоя " + this.layer.name + " с сервера " + this.url , gxp.plugins.Logger.prototype.LOG_LEVEL_NETWORK_LOCAL_ERRORS);	
            }
        }
    },
